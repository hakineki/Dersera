...
// belirtecini görmez. Kullanıcı adı değişebilir ve boşalan ada başkası kaydolabilir; hesabın oluşturma anı bu yüzden
// sahibe dahildir.
const sahibi = (h: HesapOzeti) => `${h.olusturma}:${h.kullaniciAdi}`;
