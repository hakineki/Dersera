...
const HAM_KURALLAR: Kural[] = [
  ...
  { kategori: "madde", engel: false, tam: ["votka", "viski", "rakı"], kok: ["eroin", "kokain", "esrarkeş", "bonzai", "ekstazi", "sarhoş"] },
  { kategori: "siddet", engel: false, kok: ["boğazladı", "boğazlama", "boğazlay", "bıçakladı", "bıçaklama", "bıçaklay"], ifade: ["kafasını kes", "kan gölü", "işkence et", "işkence yap"] },
